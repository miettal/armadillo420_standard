...
typedef enum gpio_int_cfg {
	...
	GPIO_INT_BOTH_EDGE = 0x5,	/*!< both edge sensitive*/
#endif
#endif
} gpio_edge_t;
...
#define MXC_GPIO_LINE_1_BASE (0)
#define MXC_GPIO_LINE_2_BASE (MXC_GPIO_LINE_1_BASE + GPIO_NUM_PIN)
#define MXC_GPIO_LINE_3_BASE (MXC_GPIO_LINE_2_BASE + GPIO_NUM_PIN)
#define MXC_GPIO_LINE_4_BASE (MXC_GPIO_LINE_3_BASE + GPIO_NUM_PIN)

#define GPIO(port, num)      (((port) - 1)*GPIO_NUM_PIN + (num))

#if defined(CONFIG_MACH_ARMADILLO460)
#define A460_CPLD_GPIO_BASE  (MXC_GPIO_LINE_4_BASE + GPIO_NUM_PIN)
#define A460_CPLD_GPIO_NUM   (2)

#define CPLD_GPIO(num)       (A460_CPLD_GPIO_BASE + (num))
#endif
