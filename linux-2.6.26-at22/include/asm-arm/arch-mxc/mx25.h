 ...
 */
#define CLOCK_TICK_RATE         133000000
 ...
 * C0000000 80000000    256M    SDRAM0
 * D0000000 90000000    256M    SDRAM1
 * E0000000 A0000000    128M    CS0 Flash
 * E8000000 A8000000    128M    CS1
 * F0000000 B0000000    32M     CS2
 * F2000000 B2000000    32M     CS3
 * F4000000 B4000000    32M     CS4
 * F6000000 B6000000    32M     CS5
...
#endif
#define USB_IRAM_BASE_ADDR   (IRAM_BASE_ADDR + CONFIG_SDMA_IRAM_SIZE)
#define USB_IRAM_SIZE        (SZ_16K * 2) /* SZ_32K */

#define SND_IRAM_BASE_ADDR   (USB_IRAM_BASE_ADDR + USB_IRAM_SIZE)
#ifdef CONFIG_SND_MXC_SOC_IRAM
#define SND_IRAM_SIZE        (SZ_64K)
#else
#define SND_IRAM_SIZE        (0)
#endif
...
#define CS1_BASE_ADDR_VIRT	0xE8000000
#define CS1_SIZE		SZ_128M
#define CS2_BASE_ADDR           0xB0000000
#define CS2_BASE_ADDR_VIRT	0xF0000000
#define CS2_SIZE		SZ_32M
#define CS3_BASE_ADDR           0xB2000000
#define CS3_BASE_ADDR_VIRT	0xF2000000
#define CS3_SIZE		SZ_32M
