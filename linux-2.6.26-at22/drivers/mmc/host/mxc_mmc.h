 ...
 *
 * This file defines offsets and bits of SDHC registers. SDHC is also referred
 * as MMC/SD controller
 *
...
#define SD_READ_TO_VALUE		0x2db4
#define SDIO_READ_TO_VALUE		0
