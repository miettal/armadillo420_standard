...
extern int flexcan_mbm_set_resframe(struct flexcan_device *flexcan, const char *buf);
extern int flexcan_mbm_del_resframe(struct flexcan_device *flexcan, const char *buf);
extern ssize_t flexcan_mbm_show_resframe(struct flexcan_device *flexcan, char *buf);
