...
typedef enum {
	/*!
	 * Tx clock on rising edge
	 */
	ssi_tx_clock_on_rising_edge = 0,
	/*!
	 * Tx clock on falling edge
	 */
	ssi_tx_clock_on_falling_edge = 1,
	/*!
	 * Rx clock on falling edge
	 */
	ssi_rx_clock_on_falling_edge = 0,
	/*!
	 * Rx clock on rising edge
	 */
	ssi_rx_clock_on_rising_edge = 1
