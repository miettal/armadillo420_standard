...
static uart_mxc_port mxc_ports[] = {
	[0] = {
	       ...
	       .mode = UART1_MODE,
	       .ir_mode = UART1_IR,
	       .enabled = CONFIG_SERIAL_MXC_ENABLED1,
	       .hardware_flow = CONFIG_SERIAL_MXC_HW_FLOW_ENABLED1,
	       ...
	       .wakeup = CONFIG_SERIAL_MXC_IS_WAKE_SRC1,
	       .regu_name = UART1_REGULATOR_NAME,
	       .use_gpio_for_dsr = 0,
	       },
	[1] = {
	       .port = {
	       ...
	       .mode = UART2_MODE,
	       .ir_mode = UART2_IR,
	       .enabled = CONFIG_SERIAL_MXC_ENABLED2,
	       .hardware_flow = CONFIG_SERIAL_MXC_HW_FLOW_ENABLED2,
	       ...
	       .wakeup = CONFIG_SERIAL_MXC_IS_WAKE_SRC2,
	       .regu_name = UART2_REGULATOR_NAME,
	...
	[2] = {
	       ...
	       .mode = UART3_MODE,
	       .ir_mode = UART3_IR,
	       .enabled = CONFIG_SERIAL_MXC_ENABLED3,
	       .hardware_flow = CONFIG_SERIAL_MXC_HW_FLOW_ENABLED3,
	       ...
	       .rxd_mux = MXC_UART_RXDMUX,
	       .wakeup = CONFIG_SERIAL_MXC_IS_WAKE_SRC3,
	       .regu_name = UART3_REGULATOR_NAME,
	       .use_gpio_for_dsr = 0,
	       },
	[3] = {
	       .port = {
	       ...
	       .mode = UART4_MODE,
	       .ir_mode = UART4_IR,
	       .enabled = CONFIG_SERIAL_MXC_ENABLED4,
	       .hardware_flow = CONFIG_SERIAL_MXC_HW_FLOW_ENABLED4,
	       ...
	       .rxd_mux = MXC_UART_RXDMUX,
	       .wakeup = CONFIG_SERIAL_MXC_IS_WAKE_SRC4,
	       .regu_name = UART4_REGULATOR_NAME,
	       .use_gpio_for_dsr = 0,
	       },
	[4] = {
	       .port = {
	       ...
	       .mode = UART5_MODE,
	       .ir_mode = UART5_IR,
	       .enabled = CONFIG_SERIAL_MXC_ENABLED5,
	       .hardware_flow = CONFIG_SERIAL_MXC_HW_FLOW_ENABLED5,
	       ...
	       .rxd_mux = MXC_UART_RXDMUX,
	       .wakeup = CONFIG_SERIAL_MXC_IS_WAKE_SRC5,
	       .regu_name = UART5_REGULATOR_NAME,
	       .use_gpio_for_dsr = 0,
	},
};
