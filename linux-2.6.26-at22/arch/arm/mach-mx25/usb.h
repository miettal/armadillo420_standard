...
extern int gpio_usbh2_pwr_enable(void);
extern int gpio_usbh2_pwr_disable(void);
...
extern void gpio_usbh2_inactive(void);
extern int gpio_usbotg_utmi_pwr_enable(void);
extern int gpio_usbotg_utmi_pwr_disable(void);
