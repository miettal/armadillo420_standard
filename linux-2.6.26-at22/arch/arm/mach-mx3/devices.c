...
#if defined(CONFIG_SDHC_MXC_SELECT1)
...
#elif defined(CONFIG_MACH_ARMADILLO500) || defined(CONFIG_MACH_ARMADILLO500FX)
...
#if defined(CONFIG_SDHC_MXC_SELECT2)
...
#if defined(CONFIG_SND_MXC_IIS) || defined(CONFIG_SND_MXC_IIS_MODULE)
static struct platform_device mxc_audio_device = {
	.name = "mxc_alsa_i2s",
	.id = 0,
};
...
{
	platform_device_register(&mxc_audio_device);
}
#else
#define mxc_init_audio()
#endif /* CONFIG_SND_MXC_IIS */
