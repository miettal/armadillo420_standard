...
extern void gpio_usbh2_xcvr_cs_enable(int enable);
extern void gpio_usbh2_xcvr_reset(void);
...
static struct fsl_usb2_platform_data usbh1_config = {
	...
	.transceiver       = "serial",
#if defined(CONFIG_USB_EHCI_ARC_H1_DELAYPROBE)
	.delay_probe	   = 1,
#endif
};
...
#if defined(CONFIG_MACH_ARMADILLO500) || defined(CONFIG_MACH_ARMADILLO500FX)
	.power_budget      = 0, /* no limit */
#else
	.power_budget      = 150,		/* 150 mA max power */
#endif
...
#if defined(CONFIG_MACH_ARMADILLO500) || defined(CONFIG_MACH_ARMADILLO500FX)
	.gpio_usb_xcvr_cs_enable = gpio_usbh2_xcvr_cs_enable,
	.gpio_usb_xcvr_reset = gpio_usbh2_xcvr_reset,
#endif
	.transceiver       = "isp1504",
#if !defined(CONFIG_USB_EHCI_ARC_H2_ALLOW_HS) \
	&& !defined(CONFIG_USB_EHCI_ARC_BOTH_ALLOW_HS)
	.fs_limit	   = 1,
#endif
#if defined(CONFIG_USB_EHCI_ARC_H2_DELAYPROBE)
	.delay_probe	   = 1,
#endif
};
...
static struct fsl_usb2_platform_data mxc_isp1504_config = {
	...
	.transceiver       = "isp1504",
#if !defined(CONFIG_USB_EHCI_ARC_OTG_ALLOW_HS) \
	&& !defined(CONFIG_USB_EHCI_ARC_BOTH_ALLOW_HS)
	.fs_limit	   = 1,
#endif
#if defined(CONFIG_USB_EHCI_ARC_OTG_DELAYPROBE)
	.delay_probe	   = 1,
#endif
};
#endif
