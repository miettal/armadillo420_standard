...
#if defined(CONFIG_SERIAL_MXC_PORT1)
	[0] = {
	       .port = {
...
#endif
#if defined(CONFIG_SERIAL_MXC_PORT2)
	[1] = {
	       .port = {
...
#endif
#if defined(CONFIG_SERIAL_MXC_PORT3)
	[2] = {
	       .port = {
...
#endif
#if defined(CONFIG_SERIAL_MXC_PORT4)
	[3] = {
	       .port = {
...
#endif
#if defined(CONFIG_SERIAL_MXC_PORT5)
	[4] = {
	       .port = {
